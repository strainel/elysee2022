...
highchart() %>% 
  ...
  hc_add_series(data = candidats_nbparrains, type = 'column', name="Parrainages",
                ...
                dataLabels = list(enabled = TRUE, useHTML = TRUE,
                                  format='<div style="width: 20px; height: 20px; overflow: hidden; border-radius: 50%"><img src="https://github.com/strainel/elysee2022/blob/main/images/{point.image}?raw=true" style="width: 30px; margin-left: -5px; margin-top: -2px"></div>
')) %>%
